...
local function init_def_rules(chat_id)
  	local rules = 'ℹ️ Rules:\n'
              ..'1⃣ No Flood.\n'
              ..'2⃣ No Spam.\n'
              ..'3⃣ Trate de permanecer en el tema.\n'
              ..'4⃣ Prohibido cualquier contenido homofobico, racista, sexual o contenido gore.\n'
              ..'➡️ Cualquier incumplimiento de estas reglas causará baneo o suspensión temporal.'
